...
2) Diseñar, implementar y realizar un análisis de complejidad temporal y espacial de dos versiones del algoritmo para calcular la aproximación de la función exponencial $ex
